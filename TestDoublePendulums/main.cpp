...
char xmlpath[] = "/home/scu/workspace/ws_lc/code/MyRobotSimulator/TestDoublePendulums/doublependulums.xml";
char datapath[] = "/home/scu/workspace/ws_lc/code/MyRobotSimulator/TestPendulum/data.csv";
...
//  printf("%f %f %f %f \n",d->time,d->energy[0],d->energy[1],d->energy[0]+d->energy[1]);
  ...
  double qref1 = -0.5, qref2 = -1.6; // 期望位置
